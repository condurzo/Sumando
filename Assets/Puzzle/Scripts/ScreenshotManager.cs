...
//		mainCam.GetComponent<UnityStandardAssets.ImageEffects.BlurOptimized> ().enabled = true;
...
//		mainCam.GetComponent<UnityStandardAssets.ImageEffects.BlurOptimized> ().enabled = false;
	...
	IEnumerator DoScreenShot () {
		...
		while (!System.IO.File.Exists(_screenshotPath))
		{
			yield return null;
		}
