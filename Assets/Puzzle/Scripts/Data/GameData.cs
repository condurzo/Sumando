...
public static class GameData {
	...
	public static int tutorialProgress
	{
		get
		{
			return PlayerPrefs.GetInt(tutorialProgressKey);
		}
		set {
			PlayerPrefs.SetInt(tutorialProgressKey, value);
		}
	}
	...
	public static int continueCounter
	{
		get
		{
			return PlayerPrefs.GetInt(continueCounterKey);
		}
		set {
			PlayerPrefs.SetInt(continueCounterKey, value);
		}
	}
	...
	public static int bonusTipShowed
	{
		get
		{
			return PlayerPrefs.GetInt(bonusTipShowedKey);
		}
		set {
	...
	public static int bonusTipShowAfterUse
	{
		get
		{
			return PlayerPrefs.GetInt(bonusTipShowAfterUseKey);
		}
		set {
...
//	public static bool bigSizeOpen
//	{
//		get
//		{
//			return PlayerPrefs.GetInt(bigSizeOpenKey, 0) == 1;
//		}
//		set {
//            if (value && value != bigSizeOpen) //open mode only once
//            {
//                PlayerPrefs.SetInt(bigSizeOpenKey, 1);
////                GPGData.open_mode++;
//            }
//		}
//	}
...
//		get
//		{
//			return PlayerPrefs.GetInt(extraOpenKey, 0) == 1;
//        }
//        set
//        {
//            if (value && value != extraOpen) //open mode only once
//            {
//                PlayerPrefs.SetInt(extraOpenKey, 1);
////                GPGData.open_mode++;
//            }
//		}
//	}
	...
	public static int coins {
		...
		set { 
			...
			else 
			{
				...
				int coinsVal = value - coins;
				if (coinsVal > 0) {
//					GPGData.collect_coins += coinsVal;
				} else {
//					GPGData.spend_coins += coinsVal;
				}
	...
	public static int IsBestScore 
	{
		get 
		{
			return PlayerPrefs.GetInt (isBestSroreKey, 0);
		}
		set
		{
			PlayerPrefs.SetInt (isBestSroreKey, value);
			if (value > 0) {
//				GPGData.beat_score++;
			}
		}
...
//				GPGData.maked_combo++;
	...
	public static int UndoBonusLevel 
	{
		get 
		{
			return PlayerPrefs.GetInt (undoBonusLevelKey, 0);
		}
		set
		{
			PlayerPrefs.SetInt (undoBonusLevelKey, value);
		}
	}
	...
	public static int HummerBonusLevel 
	{
		get 
		{
			return PlayerPrefs.GetInt (hummerBonusLevelKey, 0);
		}
		set
		{
			PlayerPrefs.SetInt (hummerBonusLevelKey, value);
		}
	}
	...
	public static int UndoPrice
	{
		get
		{
			return UndoBonusLevel * GameConfig.undoTurnDeltaPrice + GameConfig.undoTurnStartPrice;
		}
	}
	...
	public static int HummerPrice 
	{
		get 
		{ 
			return HummerBonusLevel * GameConfig.clearCellsDeltaPrice + GameConfig.clearCellsStartPrice;
		}
	}
