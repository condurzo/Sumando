...
public static class Config {
    ...
    public static string complainsEmail
    {
        get
        {
            string s = string.Format("mailto:{0}?subject={1}&body={2}", emailAdress, complainsEmailSubject, complainsEmailBody);
            return s;
        }
    }
    ...
    public static string regularEmail
    {
        get
        {
            string s = string.Format("mailto:{0}?subject={1}&body={2}", emailAdress, regularEmailSubject, regularEmailBody);
            return s;
        }
    }
}
